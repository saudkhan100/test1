    ...
    return (
        <div className="relative mx-auto grid grid-cols-7 gap-0 h-[25rem] w-full max-w-7xl flex-col items-end justify-center overflow-hidden rounded-xl bg-white bg-clip-border text-center text-gray-700">
            ...
            <div className="col-span-5 relative">
                <div className="absolute inset-0 m-0 h-full w-full overflow-hidden rounded-none bg-transparent" style={{ backgroundImage: `url(https://onedrive.live.com/embed?resid=38E489A2E9BE257B%2157267&authkey=%21AN51hcCRYQmnxHo&width=1149&height=809)`, backgroundSize: 'cover', backgroundPosition: 'center', color: '#ffffff' }}>
